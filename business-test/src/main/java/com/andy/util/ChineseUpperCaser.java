...
public class ChineseUpperCaser {
    ...
    /**
     * 对输入的字符串进行验证，如果不能转化为数字形式则抛出数字转化异常 ，注意这是一个运行时异常(非检查型异常)，程序不用显式捕获
     * 
     * @param number
     * @throws NumberFormatException
     */
    ...
    public static void main(String[] args) {
        String[] arr = { "0.002", "10.001", "1.543524304302432", "12.432423432", "123.454235", "1234", "12345", "123456", "1234567", "12345678", "123456789",
                "1234567891", "12345678912", "123456789123", "1234567891234", "12345678912345", "123456789123456", "1234567891234567", "12345678912345678",
                "123456789123456789", "123456789123456789123456089123456789123456789123450780", "0", "00", "000", "0000", "01", "001", "0001", "00001", "10",
                "100", "1000", "10000", "101", "1001", "10001", "100001", "1.23", "21.234", "243400031.233234", "5400035.980", "543.6545" };
        // String[]
        // arr={"0","00","000","0000","01","001","0001","00001","10","100","1000","10000","101","1001","10001","100001"};
